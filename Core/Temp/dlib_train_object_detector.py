...
training_xml_path =  "super_training3.xml"
# testing_xml_path = os.path.join(faces_folder, "testing.xml")
# This function does the actual training.  It will save the final detector to
# detector.svm.  The input is an XML file that lists the images in the training
# dataset and also contains the positions of the face boxes.  To create your
# own XML files you can use the imglab tool which can be found in the
# tools/imglab folder.  It is a simple graphical tool for labeling objects inmd
...
#
# detector2 = dlib.train_simple_object_detector(images, boxes, options)2018-04-30
# 20:48	IDE and Plugin Updates: PyCharm is ready to update.
