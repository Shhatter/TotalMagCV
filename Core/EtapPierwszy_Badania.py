...
def dlibFaceDetector(inputFilePath, upsample, goodPath, badPath):
    # if printDetails:
    # file.writelines(
    ...
    width, height = inputFile.shape[:2]
    print("width: " + str(width) + " height: " + str(height) + "\n")
    rects = detector(grayImage, upsample)
    if len(rects) != 1:
        # cv2.imwrite(badPath + pathlib.Path(inputFilePath).name, inputFile)
        badResult += 1
    else:
...
'''
    ...
    fall_out__False_Positive_Rate = FP / (FP + TN)
    False_Negative_Rate = FN / (TP + FN)

    fMeasure = 2 * ((precision * recall_True_Positive_Rate) / (precision + recall_True_Positive_Rate))

    return accuracy, precision, recall_True_Positive_Rate, specificity_TNR, fall_out__False_Positive_Rate, False_Negative_Rate, fMeasure
    return "\taccuracy:\t" + str(accuracy) + "\tprecision:\t" + str(precision) + "\trecall(TPR):\t" + str(
        recall) + "\tfallout(FPR):\t" + str(fallout) + "\tfMeasure:\t" + str(fMeasure)
    ...
    if (alghoritmName == "HAAR"):
        ...
        if (mode == "SICK"):
            ...
            for i in range(11, 12, 1):
                ...
                badResult = 0
            file.writelines(
                getTime + "\tSICK \tHOG: Upsample " + str(values[0]) + "\ttruePositive:\t" + str(
            ...
            for i in range(1, 11, 1):
                ...
                badResult = 0
            file.writelines(
                getTime + "\tHEALTHY\tHOG: Upsample " + str(values[0]) + "\ttruePositive:\t" + str(
                    truePositive) + "\tfalseNegative:\t" +
                str(falseNegative) + "\tfalsePositive:\t" + str(
                    falsePositive) + "\ttrueNegative:\t" + str(
                    trueNegative) + "\tTotal:\t" + str(
...
# researchOrderer("HOG", "HEALTHY", [0], 0)
# researchOrderer("HOG", "HEALTHY", [1], 0)
# researchOrderer("HOG", "HEALTHY", [2], 0)
# researchOrderer("HOG", "HEALTHY", [3], 0)
# researchOrderer("HOG", "HEALTHY", [4], 0)
# researchOrderer("HOG", "HEALTHY", [5], 0)
# researchOrderer("HOG", "HEALTHY", [6], 0)
# researchOrderer("HOG", "HEALTHY", [7], 0)
# researchOrderer("HOG", "HEALTHY", [8], 0)
# researchOrderer("HOG", "HEALTHY", [9], 0)
# researchOrderer("HOG", "HEALTHY", [10], 0)


# researchOrderer("HOG", "HEALTHY", [11], 0)
# researchOrderer("HOG", "HEALTHY", [12], 0)
# researchOrderer("HOG", "HEALTHY", [13], 0)
# researchOrderer("HOG", "HEALTHY", [14], 0)
# researchOrderer("HOG", "HEALTHY", [15], 0)
# researchOrderer("HOG", "HEALTHY", [16], 0)
# researchOrderer("HOG", "HEALTHY", [17], 0)
# researchOrderer("HOG", "HEALTHY", [18], 0)
# researchOrderer("HOG", "HEALTHY", [19], 0)
# researchOrderer("HOG", "HEALTHY", [20], 0)
# researchOrderer("HOG", "HEALTHY", [21], 0)
# researchOrderer("HOG", "HEALTHY", [22], 0)
# researchOrderer("HOG", "HEALTHY", [23], 0)
# researchOrderer("HOG", "HEALTHY", [24], 0)
# researchOrderer("HOG", "HEALTHY", [25], 0)
# researchOrderer("HOG", "HEALTHY", [26], 0)
# researchOrderer("HOG", "HEALTHY", [27], 0)
# researchOrderer("HOG", "HEALTHY", [28], 0)
# researchOrderer("HOG", "HEALTHY", [29], 0)
# researchOrderer("HOG", "HEALTHY", [30], 0)
# researchOrderer("HOG", "HEALTHY", [31], 0)
# researchOrderer("HOG", "HEALTHY", [32], 0)
# researchOrderer("HOG", "HEALTHY", [33], 0)
# researchOrderer("HOG", "HEALTHY", [34], 0)
# researchOrderer("HOG", "HEALTHY", [35], 0)
# researchOrderer("HOG", "HEALTHY", [36], 0)
# researchOrderer("HOG", "HEALTHY", [37], 0)
# researchOrderer("HOG", "HEALTHY", [38], 0)
# researchOrderer("HOG", "HEALTHY", [39], 0)
# researchOrderer("HOG", "HEALTHY", [40], 0)
# researchOrderer("HOG", "HEALTHY", [41], 0)
# researchOrderer("HOG", "HEALTHY", [42], 0)
# researchOrderer("HOG", "HEALTHY", [43], 0)
# researchOrderer("HOG", "HEALTHY", [44], 0)
# researchOrderer("HOG", "HEALTHY", [45], 0)
# researchOrderer("HOG", "HEALTHY", [46], 0)
# researchOrderer("HOG", "HEALTHY", [47], 0)
# researchOrderer("HOG", "HEALTHY", [48], 0)
# researchOrderer("HOG", "HEALTHY", [49], 0)
# researchOrderer("HOG", "HEALTHY", [50], 0)
# researchOrderer("HOG", "HEALTHY", [51], 0)
# researchOrderer("HOG", "HEALTHY", [52], 0)
# researchOrderer("HOG", "HEALTHY", [53], 0)
# researchOrderer("HOG", "HEALTHY", [54], 0)
# researchOrderer("HOG", "HEALTHY", [55], 0)
# researchOrderer("HOG", "HEALTHY", [56], 0)
# researchOrderer("HOG", "HEALTHY", [57], 0)
# researchOrderer("HOG", "HEALTHY", [58], 0)
# researchOrderer("HOG", "HEALTHY", [59], 0)
# researchOrderer("HOG", "HEALTHY", [60], 0)
# researchOrderer("HOG", "HEALTHY", [61], 0)
# researchOrderer("HOG", "HEALTHY", [62], 0)
# researchOrderer("HOG", "HEALTHY", [63], 0)
# researchOrderer("HOG", "HEALTHY", [64], 0)
# researchOrderer("HOG", "HEALTHY", [65], 0)
# researchOrderer("HOG", "HEALTHY", [66], 0)
# researchOrderer("HOG", "HEALTHY", [67], 0)
# researchOrderer("HOG", "HEALTHY", [68], 0)
# researchOrderer("HOG", "HEALTHY", [69], 0)
# researchOrderer("HOG", "HEALTHY", [70], 0)
# researchOrderer("HOG", "HEALTHY", [71], 0)
# researchOrderer("HOG", "HEALTHY", [72], 0)
# researchOrderer("HOG", "HEALTHY", [73], 0)
# researchOrderer("HOG", "HEALTHY", [74], 0)
# researchOrderer("HOG", "HEALTHY", [75], 0)
# researchOrderer("HOG", "HEALTHY", [76], 0)
# researchOrderer("HOG", "HEALTHY", [77], 0)
# researchOrderer("HOG", "HEALTHY", [78], 0)
# researchOrderer("HOG", "HEALTHY", [79], 0)
# researchOrderer("HOG", "HEALTHY", [80], 0)
# researchOrderer("HOG", "HEALTHY", [81], 0)
# researchOrderer("HOG", "HEALTHY", [82], 0)
# researchOrderer("HOG", "HEALTHY", [83], 0)
# researchOrderer("HOG", "HEALTHY", [84], 0)
# researchOrderer("HOG", "HEALTHY", [85], 0)
# researchOrderer("HOG", "HEALTHY", [86], 0)
# researchOrderer("HOG", "HEALTHY", [87], 0)
# researchOrderer("HOG", "HEALTHY", [88], 0)
# researchOrderer("HOG", "HEALTHY", [89], 0)
# researchOrderer("HOG", "HEALTHY", [90], 0)
# researchOrderer("HOG", "HEALTHY", [91], 0)
# researchOrderer("HOG", "HEALTHY", [92], 0)
# researchOrderer("HOG", "HEALTHY", [93], 0)
# researchOrderer("HOG", "HEALTHY", [94], 0)
# researchOrderer("HOG", "HEALTHY", [95], 0)
# researchOrderer("HOG", "HEALTHY", [96], 0)
# researchOrderer("HOG", "HEALTHY", [97], 0)
# researchOrderer("HOG", "HEALTHY", [98], 0)
# researchOrderer("HOG", "HEALTHY", [99], 0)
# researchOrderer("HOG", "HEALTHY", [100], 0)
